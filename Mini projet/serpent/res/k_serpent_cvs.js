...
function serpent_touch(evt){
	...
	if(touche != 37 && touche != 38 && touche != 39 && touche != 40 && touche != 80 && touche != 112){
		return false;
	}
...
function fin(){
	...
	ctx.fillText('Game Over!', ((canvas.width / 2) - (ctx.measureText('fin de partie!').width / 2)), 100);
